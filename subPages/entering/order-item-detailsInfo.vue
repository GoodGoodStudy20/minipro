  ...
  <view class="order-item-details-box">
    ...
    <view class="progress-box">
      <view class="top">
        ...
        <text class="right error" v-if="orderDeatilsInfo.orderType ==18">办理失败——{{orderType}}</text>
    ...
    <view class="uni-btn-v" v-else>
      <view class="recording"
        v-if="(orderDeatilsInfo.orderType == 3 || orderDeatilsInfo.orderType == 4 || orderDeatilsInfo.orderType == 11 ||orderDeatilsInfo.orderType == 14 || orderDeatilsInfo.orderType == 21 || orderDeatilsInfo.orderType == 22 || orderDeatilsInfo.orderType == 23 || orderDeatilsInfo.orderType == 24) && (userInfo.roleId == 1 || (userInfo.roleId == 2 && userInfo.userId == orderDeatilsInfo.createrId))">
        <button type="primary" @tap="orderItemDetailsInfo(orderDeatilsInfo)">转派订单</button>
      </view>
      <view class="distribute"
        :class="{'close-btn':(orderDeatilsInfo.orderType != 3 && orderDeatilsInfo.orderType != 11 && orderDeatilsInfo.orderType != 21)||!(userInfo.roleId == 1 || (userInfo.roleId == 2 && userInfo.userId == orderDeatilsInfo.createrId))}">
...
<script>
  ...
  computed: {
    ...
    onLoad(options) {
      ...
      // console.log('user111', this.orderDeatilsInfo);
    },
    methods: {
      preivewImg(index) {
        console.log(index);
      ...
      async frontPageOrderDetailsFun() {
        ...
        console.log(22222,(this.userInfo.roleId == 2 && this.userInfo.userId == this.orderDeatilsInfo.createrId));
...
<style lang="scss" scoped>
  @import '../../pages/my/seats/order-item-detailsInfo.scss'
</style>
