<template>
	<view class="order-item-details-box">
		...
		<view class="order-item-details">
			...
			<view class="key-box">
				...
				<view class="yearly-inspection">
					...
					<image :src="orderDeatilsInfo.annualInspectionImage" class="yearly-inspection-image"
						mode="aspectFit">
					</image>
				</view>
			</view>
		...
		<view class="">
			<view class="vehicle-collection">
				...
				<view class="bottom-img">
					<view class="img-box">
						<image :src="orderDeatilsInfo.pickupOrderPhoto" class="img" mode="aspectFill"></image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.pickupFrontPhotoTwo" class="img" mode="aspectFill"></image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.pickupDrivingLicensePhoto" class="img" mode="aspectFill"></image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.pickupOdometerPhoto" class="img" mode="aspectFill"></image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.pickupFrontPhoto" class="img" mode="aspectFill"></image>
					</view>
				</view>
			</view>
			<view class="vehicle-collection">
				...
				<view class="bottom-img">
					<view class="img-box">
						<image :src="orderDeatilsInfo.returnOrderPhoto" class="img" mode="aspectFill"></image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.returnFrontPhotoTwo" class="img" mode="aspectFill"></image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.returnDrivingLicensePhoto" class="img" mode="aspectFill">
						</image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.returnOdometerPhoto" class="img" mode="aspectFill"></image>
					</view>
					<view class="img-box">
						<image :src="orderDeatilsInfo.returnFrontPhoto" class="img" mode="aspectFill"></image>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="uni-btn-v" v-else>
			...
			<!-- <view class="recording"v-if="orderDeatilsInfo.orderType == 4 || orderDeatilsInfo.orderType == 11 || orderDeatilsInfo.orderType == 22 || orderDeatilsInfo.orderType == 23 || orderDeatilsInfo.orderType == 24"> -->
				<button type="primary" @tap="orderItemDetailsInfo(orderDeatilsInfo)">转派订单</button>
			</view>
			<!-- <view class="distribute"
				:class="{'close-btn':orderDeatilsInfo.orderType != 3 && orderDeatilsInfo.orderType != 11}"> -->
			<view class="distribute"
				:class="{'close-btn':orderDeatilsInfo.orderType != 11}">
