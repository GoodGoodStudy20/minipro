...
<script>
	...
	export default {
		...
		data() {
			return {
        defaultValue: uni.getStorageSync('codecity'),
				value: [],
				addressList,
				provinceList: [],
				cityList: [],
      ...
      defaultValue:{
        handler(val){
        this.defaultValue = uni.getStorageSync('codecity')
        },
        immediate:true,
        dep:true
      ...
      console.log('ppppppp---',this.defaultValue);
          ...
          console.log('1111111111',this.defaultValue);
          ...
          console.log('ref',this.$refs.picke1);
					...
					console.log('999',this.areaList, this.defaultValue)
					console.log('888',this.cityIndex)
					...
					console.log('66666',this.areaIndex)
          this.$nextTick(()=>{
            setTimeout(()=>{
		...
		methods: {
			confirm () {
				console.log('conf',this.provinceIndex, this.cityIndex, this.areaIndex)
				this.$emit('confirm', {
